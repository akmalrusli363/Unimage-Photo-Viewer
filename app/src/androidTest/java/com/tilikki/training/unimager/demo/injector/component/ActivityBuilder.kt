...
abstract class ActivityBuilder {
    @ContributesAndroidInjector(modules = [MainActivityModule::class, PhotoGridFragmentModule::class])
    ...
    @ContributesAndroidInjector(modules = [ProfileActivityModule::class, PhotoGridFragmentModule::class])
